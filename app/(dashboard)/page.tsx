...
const baseSections = [
  ...
  },
  {
    ...
    href: "/competitors",
    icon: Swords,
    description: "Compare criadores e marcas do seu nicho",
    stat: "Perfis salvos no Supabase",
    badge: "Comparativo",
  ...
  },
  {
    ...
    href: "/news",
    icon: Newspaper,
    description: "IA, engenharia e qualidade em um feed",
    stat: "8 fontes monitoradas",
    badge: "Ao vivo",
    badgeVariant: "default" as const,
